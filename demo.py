...
def train_model(model, chosen_loss_c, optimizer, scheduler,K,ccp,num_epochs,meta_method):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            final_epoch_acc.append(epoch_acc)
...
plt.plot( 'epoch', 'y3_values', data=df, marker='', color='green', linewidth=2, linestyle='dashed', label="ga")
